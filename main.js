...
const galleryData = {
    ...
    editing: {
        ...
        items: [
            { title: 'Reel تشويقي لحدث في النادي', category: 'Reels', description: 'مونتاج ريل تشويقي لمشاركة النادي في معرض دمشق الدولي', type: 'video', src: 'https://drive.google.com/file/d/1g-qRWN-MR2ynj_nmlwX1mgkjABxgYBig/view?usp=drive_link', thumbnail: './assets/editing/99.png' },
