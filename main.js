...
const galleryData = {
    design: {
        ...
        items: [
            { title: '  تصميم متطوع الشهر', category: 'الإعلانات + تصاميم', description: ' تصميم متطوع الشهر لفريق الهمك للذكاء الاصطناعي و الروبوتيك ', type: 'image', src: './assets/design/m0.png',thumbnail: './assets/design/m0.png' },
